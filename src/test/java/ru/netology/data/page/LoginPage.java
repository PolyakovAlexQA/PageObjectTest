...
public class LoginPage {
    public static VerificationPage validLogin(DataHelper.AuthInfo info) { // указываем класс от куда берем дата-данные и метод класса AuthInfo от куда мы возвращаем логи и пароль
